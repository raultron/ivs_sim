...
#Results for 5 points ill conditioned 
D9pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D10pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D11pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D12pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D13pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D14pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D15pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
D16pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 1000)
...
for cam in cams:
  ...
  pl.random(n =9, r = 0.01, min_sep = 0.01)
   
  D9pIll.Camera.append(cam)  
  D9pIll.ObjectPoints.append(pl.get_points())
  D9pIll.calculate_metrics()
  
  pl.random(n =10, r = 0.01, min_sep = 0.01)
  
  D10pIll.Camera.append(cam)  
  D10pIll.ObjectPoints.append(pl.get_points())
  D10pIll.calculate_metrics()

  pl.random(n=11, r = 0.01, min_sep = 0.01)
  
  D11pIll.Camera.append(cam)  
  D11pIll.ObjectPoints.append(pl.get_points())
  D11pIll.calculate_metrics()
  
  pl.random(n =12, r = 0.01, min_sep = 0.01)
  
  D12pIll.Camera.append(cam)  
  D12pIll.ObjectPoints.append(pl.get_points())
  D12pIll.calculate_metrics()

  pl.random(n =13, r = 0.01, min_sep = 0.01)

  D13pIll.Camera.append(cam)  
  D13pIll.ObjectPoints.append(pl.get_points())
  D13pIll.calculate_metrics()
  
  pl.random(n =14, r = 0.01, min_sep = 0.01)  
  
  D14pIll.Camera.append(cam)  
  D14pIll.ObjectPoints.append(pl.get_points())
  D14pIll.calculate_metrics()
  
  pl.random(n =15, r = 0.01, min_sep = 0.01)
  
  D15pIll.Camera.append(cam)  
  D15pIll.ObjectPoints.append(pl.get_points())
  D15pIll.calculate_metrics()

  pl.random(n =16, r = 0.01, min_sep = 0.01)
  
  D16pIll.Camera.append(cam)  
  D16pIll.ObjectPoints.append(pl.get_points())
  D16pIll.calculate_metrics()
...
pickle.dump([D9pIll,D10pIll,D11pIll,D12pIll,D13pIll,D14pIll,D15pIll,D16pIll], open( "icra_sim_ill_only_9-16points.p", "wb" ) )
