...
#fig12 = plt.figure('Control Points plane Coordinates',figsize=(fig_width,fig_width))
...
#another figure for all Pose errors
...
ax_image.plot(imagePoints_asarray[0,-Din['n']:],imagePoints_asarray[1,-Din['n']:],'o',color = 'red',)
...
ax_object.plot(objectPoints_asarray[0,-Din['n']:],objectPoints_asarray[1,-Din['n']:],'o',color = 'red',)
pl.plot_plane()
...
fig11.savefig('dynamic-markers-optimal/img/image_control_points.pdf')
fig11.savefig('dynamic-markers-optimal/img/image_control_points.png', dpi=900)
#fig11.tight_layout()
plt.show()
plt.pause(0.001)
