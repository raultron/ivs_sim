...
%      \centering
%       \includegraphics[draft,width=0.5\textwidth]{draft.png}
%       \caption{Matrix condition number (cost function) and Homography estimation error for different methods during the gradient search of the optimal 4-point configuration.}\label{A}
% \end{figure}
