...
def calculate_A_matrix_autograd(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,P,normalize=False):
  ...
  object_pts = np.hstack([X1,X2,X3,X4,X5,X6,X7])
  image_pts = np.hstack([U1,U2,U3,U4,U5,U6,U7])
...
def matrix_condition_number_autograd(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,P,normalize = False):
  A = calculate_A_matrix_autograd(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,P,normalize)  
...
def evaluate_gradient(gradient, objectPoints, P, normalize = False):
  x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7 = extract_objectpoints_vars(objectPoints)
  ...
  gradient.dx1_eval = gradient.dx1(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x1
  gradient.dy1_eval = gradient.dy1(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y1

  gradient.dx2_eval = gradient.dx2(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x2
  gradient.dy2_eval = gradient.dy2(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y2

  gradient.dx3_eval = gradient.dx3(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x3
  gradient.dy3_eval = gradient.dy3(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y3

  gradient.dx4_eval = gradient.dx4(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x4
  gradient.dy4_eval = gradient.dy4(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y4

  gradient.dx5_eval = gradient.dx5(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x5
  gradient.dy5_eval = gradient.dy5(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y5

  gradient.dx6_eval = gradient.dx6(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x6
  gradient.dy6_eval = gradient.dy6(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y6
  
  gradient.dx7_eval = gradient.dx7(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_x7
  gradient.dy7_eval = gradient.dy7(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7, P, normalize)*gradient.n_y7
