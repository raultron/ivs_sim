...
def calculate_A_matrix_autograd(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8,P,normalize=False):
  ...
  X7 = np.array([[x7],[y7],[0.],[1.]]).reshape(4,1)
  X8 = np.array([[x8],[y8],[0.],[1.]]).reshape(4,1)
  ...
  U7 = np.array(np.dot(P,X7)).reshape(3,1)
  U8 = np.array(np.dot(P,X8)).reshape(3,1)

  object_pts = np.hstack([X1,X2,X3,X4,X5,X6,X7,X8])
  image_pts = np.hstack([U1,U2,U3,U4,U5,U6,U7,U8])
  ...
  x7 = object_pts_norm[0,6]/object_pts_norm[2,6]
  y7 = object_pts_norm[1,6]/object_pts_norm[2,6]
  
  x8 = object_pts_norm[0,7]/object_pts_norm[2,7]
  y8 = object_pts_norm[1,7]/object_pts_norm[2,7]
  ...
  u7 = image_pts_norm[0,6]/image_pts_norm[2,6]
  v7 = image_pts_norm[1,6]/image_pts_norm[2,6]
  
  u8 = image_pts_norm[0,7]/image_pts_norm[2,7]
  v8 = image_pts_norm[1,7]/image_pts_norm[2,7]
  ...
  A = np.array([    [ 0,  0, 0, -x1, -y1, -1,  v1*x1,  v1*y1,  v1],
                    ...
                    [0,   0, 0, -x7, -y7, -1,  v7*x7,  v7*y7,  v7],
                    [x7, y7, 1,   0,   0,  0, -u7*x7, -u7*y7, -u7],

                    [0,   0, 0, -x8, -y8, -1,  v8*x8,  v8*y8,  v8],
                    [x8, y8, 1,   0,   0,  0, -u8*x8, -u8*y8, -u8],
          ])
  return A


def matrix_condition_number_autograd(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8,P,normalize = False):
  A = calculate_A_matrix_autograd(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8,P,normalize)  
...
def create_gradient(metric='condition_number', n = 0.000001):
  ...
  gradient.dx7 = grad(metric_function,12)
  gradient.dy7 = grad(metric_function,13)
  
  gradient.dx8 = grad(metric_function,14)
  gradient.dy8 = grad(metric_function,15)
...
def evaluate_gradient(gradient, objectPoints, P, normalize = False):
  x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8 = extract_objectpoints_vars(objectPoints)
  ...
  gradient.dx1_eval = gradient.dx1(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x1
  gradient.dy1_eval = gradient.dy1(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y1

  gradient.dx2_eval = gradient.dx2(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x2
  gradient.dy2_eval = gradient.dy2(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y2

  gradient.dx3_eval = gradient.dx3(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x3
  gradient.dy3_eval = gradient.dy3(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y3

  gradient.dx4_eval = gradient.dx4(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x4
  gradient.dy4_eval = gradient.dy4(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y4

  gradient.dx5_eval = gradient.dx5(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x5
  gradient.dy5_eval = gradient.dy5(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y5

  gradient.dx6_eval = gradient.dx6(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x6
  gradient.dy6_eval = gradient.dy6(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y6
  
  gradient.dx7_eval = gradient.dx7(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x7
  gradient.dy7_eval = gradient.dy7(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y7
  
  gradient.dx8_eval = gradient.dx8(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_x8
  gradient.dy8_eval = gradient.dy8(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6,x7,y7,x8,y8, P, normalize)*gradient.n_y8
  ...
  gradient.n_x7 = supersab(gradient.n_x7,gradient.dx7_eval,gradient.dx7_eval_old,gradient.n_pos,gradient.n_neg)
  gradient.n_x8 = supersab(gradient.n_x8,gradient.dx8_eval,gradient.dx8_eval_old,gradient.n_pos,gradient.n_neg)
  ...
  gradient.n_y7 = supersab(gradient.n_y7,gradient.dy7_eval,gradient.dy7_eval_old,gradient.n_pos,gradient.n_neg)
  gradient.n_y8 = supersab(gradient.n_y8,gradient.dy8_eval,gradient.dy8_eval_old,gradient.n_pos,gradient.n_neg)
...
def update_points(gradient, objectPoints, limitx=0.15,limity=0.15):
  ...
  op[0,6] += - gradient.dx7_eval
  op[1,6] += - gradient.dy7_eval
  
  op[0,7] += - gradient.dx8_eval
  op[1,7] += - gradient.dy8_eval
