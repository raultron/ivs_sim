...
D4pIll = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 10000)
#Results for 4 points well conditioned (after gradient)
D4pWell = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 10000)
#Results for 4 points in a square
D4pSquare = DataSimOut(n,pl,validation_plane, ImageNoise = 4, ValidationIters = 10000)
...
print np.median(np.array(D4pSquare.pnp_tvec_error_mean)/np.array(D4pWell.pnp_tvec_error_mean))
print np.median(np.array(D4pSquare.Homo_CV_mean)/np.array(D4pWell.Homo_CV_mean))
  

pickle.dump([D4pIll,D4pWell], open( "icra_sim_squarevsWell_4points.p", "wb" ) )
